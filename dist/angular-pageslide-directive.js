                             ...
                             function ($document, $timeout) {
                                 ...
                                 return {
                                     ...
                                     link: function ($scope, el, attrs) {
                                         ...
                                         param.bodyClass = $scope.psBodyClass === 'true' || false;
                                         ...
                                         * */
                                         ...
                                         $scope.$watch('psClickOutside', function(newValue, oldValue) {
                                             if (oldValue !== newValue) {
                                                 param.clickOutside = !param.clickOutside;
                                             }
                                         });

                                         $scope.$watch('psSqueeze', function(newValue, oldValue) {
                                             if (oldValue !== newValue) {
                                                 param.squeeze = !param.squeeze;
                                             }
                                         ...
                                         $scope.$watch('psBodyClass', function(newValue, oldValue) {
                                             if (oldValue !== newValue) {
                                                 param.bodyClass = !param.bodyClass;
                                             }
                                         });
